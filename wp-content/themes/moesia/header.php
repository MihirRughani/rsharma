...
<link rel='stylesheet' id='moesia-pretty-photo-css'  href='<?php bloginfo('template_directory'); ?>/inc/prettyphoto/css/prettyPhoto.min.css?ver=4.3.1' type='text/css' media='all' />
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/inc/prettyphoto/js/jquery.prettyPhoto.min.js?ver=1'></script>
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/inc/prettyphoto/js/prettyphoto-init.js?ver=1'></script>

<!-- <script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/js/carousel-init.js?ver=1'></script>
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/js/slick.min.js?ver=1'></script>

<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>plugins/sydney-portfolio//lib/js/isotope.min.js?ver=1'></script>
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>plugins/moesia-masonry-portfolio//lib/js/isotope.min.js?ver=1'></script> -->
